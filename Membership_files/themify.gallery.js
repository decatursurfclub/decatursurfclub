...
ThemifyGallery = {
	...
	getYoutubePath : function( url ) {
		if( url.match( /youtu\.be/i ) ) {
			...
			return '/web/20160911232037/http://youtube.com/watch?v=' + url.match( /youtu\.be\/([^\?]*)/i )[1];
		} else {
			return '/web/20160911232037/http://youtube.com/watch?v=' + ThemifyGallery.getParam( 'v', url );
		}
	},
